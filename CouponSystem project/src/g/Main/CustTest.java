...
//		// cs2.shutDown();
		...
		CustomerFacade custf = (CustomerFacade) cs3.login("customerD", "12365", ClientType.CUSTOMER);

		// PURCHASING COUPON -

		System.out.println("Purchasing coupon with ID 7 - ");
		Coupon coupon = custf.getCouponByID(7);
