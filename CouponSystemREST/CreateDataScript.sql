...
Insert into coupon(title, start_date, end_date, expired, type, message, price, image) values('couponA', '2016-01-01', '2016-12-31', 'no', 'Food', 'Bakery sales 50 percent off', 50, 'http://bebopandco.com/wp-content/uploads/2014/01/kitten-cute-coloring-page-25999-150x150.jpg');
Insert into coupon(title, start_date, end_date, expired, type, message, price, image) values('couponB', '2016-12-01', '2018-06-30', 'no', 'Alcohol', 'Wine sale for dedicated customers', 120, 'https://imgstorage1.contextly.com/thumbnails/loveandkissespetsitting/11965460/150x150.jpg');
Insert into coupon(title, start_date, end_date, expired, type, message, price, image) values('couponC', '2016-10-01', '2018-05-30', 'no', 'Video', 'Classic movies from 80s', 15, 'http://pulpbits.net/wp-content/uploads/2014/02/kitten-persian-150x150.jpg');
Insert into coupon(title, start_date, end_date, expired, type, message, price, image) values('couponD', '2016-10-01', '2018-05-30', 'no', 'Games', 'Third person shooter', 25, 'http://pulpbits.net/wp-content/uploads/2014/02/himalayan-kitten2-150x150.jpg');
Insert into coupon(title, start_date, end_date, expired, type, message, price, image) values('couponE', '2016-10-01', '2018-04-30', 'no', 'Travel', 'Flight ticket', 200, 'http://pulpbits.net/wp-content/uploads/2014/02/White-Teacup-Persian-Male-kitten-150x150.jpg');
Insert into coupon(title, start_date, end_date, expired, type, message, price, image) values('couponF', '2016-10-01', '2018-03-30', 'no', 'Study', 'Java for beginners', 75, 'https://www.busybeegardencentre.co.uk/gallery/ginger%20cat-thumbnail.jpg');
Insert into coupon(title, start_date, end_date, expired, type, message, price, image) values('couponG', '2017-02-01', '2020-03-30', 'no', 'XXX', 'Adult', 400, 'http://harlequinblog.com/wp-content/uploads/2015/10/cat3-150x150.jpg');
...
Insert into compcoupon(CompanyID, CouponID, CouponAmount) values(5,7,10);
...
Insert into custcoupon(CustomerID, CouponID, CouponAmount) values(4,1,1);
